package com.biz.navimate.zxing;
...
public class IntentIntegrator {
    ...
    public final AlertDialog initiateScan(Collection<String> desiredBarcodeFormats, int cameraId) {
        ...
        startActivityForResult(intentScan, Constants.RequestCodes.ZXING);
        return null;
    }
     ...
     *  else an {@link IntentIntegrator} containing the result of the scan. If the user cancelled scanning,
     *  the fields will be null.
     */
    public static IntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == Constants.RequestCodes.ZXING) {
